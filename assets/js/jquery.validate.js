	...
	e.extend(e.fn, {
		...
		prototype : {
			...
			element : function(t) {
				...
				return n ?
				delete this.invalid[t.name] : this.invalid[t.name] = !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), n
			},
			...
			stopRequest : function(t, n) {
				...
				delete this.pending[t.name], n && this.pendingRequest === 0 && this.formSubmitted && this.form() ? (e(this.currentForm).submit(), this.formSubmitted = !1) : !n && this.pendingRequest === 0 && this.formSubmitted && (e(this.currentForm).triggerHandler("invalid-form", [this]), this.formSubmitted = !1)
			},
		...
		attributeRules : function(t) {
			...
			return n.maxlength && /-1|2147483647|524288/.test(n.maxlength) &&
		...
		normalizeRules : function(t, n) {
			return e.each(t, function(r, i) {
				...
				if (i.param || i.depends) {
					...
					s ? t[r] = i.param !== undefined ? i.param : !0 :
					delete t[r]
				}
			...
			delete t.min,
			delete t.max), t.minlength && t.maxlength && (t.rangelength = [t.minlength, t.maxlength],
			delete t.minlength,
			delete t.maxlength)), t
		},
				...
				return o[n.name] = t, e.ajax(e.extend(!0, {
					...
					success : function(r) {
						...
						if (o) {
							...
							s.prepareElement(n), s.formSubmitted = u, s.successList.push(n),
							delete s.invalid[n.name], s.showErrors()
						} else {
